...
export class BootScene extends Phaser.Scene {
  ...
  preload() {
    ...
    // Helper: load a tiered spritesheet by Phaser key
    ...
    loadTiered('player-ride');
    loadTiered('player-attack');
    loadTiered('player-start');
    loadTiered('player-powered');
    loadTiered('player-speedup');
    loadTiered('player-rocket-launch');
    loadTiered('player-collect-rocket');
    loadTiered('player-collect-shield');
    loadTiered('player-collect-hit');

    // VFX spritesheets — also tiered
    loadTiered('slash-vfx');
    loadTiered('explosion');

    // Non-tiered spritesheets — binary desktop/mobile (small VRAM, not worth 5 tiers)
    ...
    // explosion + slash-vfx loaded above via loadTiered()
